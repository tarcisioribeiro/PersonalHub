...
Django permite criar comandos customizados de gerenciamento que podem ser executados via `python manage.py <comando>`. O PersonalHub possui vários comandos úteis para manutenção, setup e operações administrativas.
